<template>
  <q-page class="q-pa-md">
    <div class="row items-center q-mb-lg">
      ...
      <div class="col-auto">
        <q-btn
          color="primary"
          label="ویرایش"
          :to="{ name: 'Panel.Class.Edit', params: { id: schoolClassData?.id } }" />
      </div>
    </div>
    ...
    <template v-else-if="schoolClassData">
      <q-card class="q-mb-md">
        <q-card-section>
          <div class="row q-col-gutter-md">
            <div class="col-12 col-md-6">
              <div class="text-subtitle2">نام کلاس:</div>
              <div class="text-body1">{{ schoolClassData.name }}</div>
            </div>
            <div class="col-12 col-md-6">
              <div class="text-subtitle2">رشته:</div>
              <div class="text-body1">{{ schoolClassData.academicField?.name || '-' }}</div>
            </div>
            <div class="col-12 col-md-6">
              <div class="text-subtitle2">پایه:</div>
              <div class="text-body1">{{ schoolClassData.academicLevel?.name || '-' }}</div>
            </div>
            <div class="col-12 col-md-6">
