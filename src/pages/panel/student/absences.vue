    ...
    <template v-else>
      <div class="row q-col-gutter-md q-mb-md">
        <div class="col-12 col-md-3">
          <q-input v-model="filters.date_from" label="از تاریخ" outlined type="date" @update:model-value="loadAbsences" />
        </div>
        <div class="col-12 col-md-3">
          <q-input v-model="filters.date_to" label="تا تاریخ" outlined type="date" @update:model-value="loadAbsences" />
        </div>
      </div>
      ...
      <q-card>
        <q-card-section>
          ...
          <div v-else class="text-center q-pa-lg">
            <q-icon name="event_available" size="100px" color="positive" />
